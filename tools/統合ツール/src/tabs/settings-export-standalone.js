...
export async function runSettingsExportSearchStandalone(keyword, guestId, setStatus) {
...
export async function runSettingsExportStandalone(mode, opts, setStatus) {
